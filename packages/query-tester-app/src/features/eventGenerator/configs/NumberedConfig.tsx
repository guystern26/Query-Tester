...
const inputCls =
  'px-2 py-1.5 text-xs bg-navy-950 border border-slate-800 rounded text-slate-300 placeholder-slate-600 focus:outline-none focus:border-blue-300 transition';
