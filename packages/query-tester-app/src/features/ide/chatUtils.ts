...
export interface ParsedAction {
    id: string;
    type: 'run_query' | 'update_spl' | 'auto_query' | 'debug_pipeline' | 'splunk_rest';
    payload: string;
}
...
const ACTION_BLOCK_REGEX = /~~~action:(run_query|update_spl|auto_query|debug_pipeline|splunk_rest)\n([\s\S]*?)~~~/g;
